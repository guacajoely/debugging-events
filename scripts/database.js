...
// 2. The 4th and 8th kids' wishes had an extra "s" in the keyword wish
// 3. the 8th celebrity's name keyword was spelled mane
...
export const getChildren = () => {
    return database.children.map(childObject => ({...childObject}))
}

export const getCelebrities = () => {
    return database.celebrities.map(celebrityObject => ({...celebrityObject}))
}
